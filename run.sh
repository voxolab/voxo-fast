...
cat $wdir/seg/$show.g.seg | ./bin/51meignier2ctm.perl | ./bin/03kaldi.perl $wdir/decode $wdir/audio/$show.wav 16000

# Start decoding
./bin/decode.sh $wdir/decode $gpu $threads $lm $graph $model $models
